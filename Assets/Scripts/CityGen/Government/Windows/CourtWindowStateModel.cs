...
{
    /// <summary>Batch 13: full court window pane payload for UI binding.</summary>
    public sealed class CourtWindowStateModel
    {
        public CourtWindowMode ActiveMode { get; set; }
        ...
        public bool IsReservedSlotMode { get; set; }
    }
}
