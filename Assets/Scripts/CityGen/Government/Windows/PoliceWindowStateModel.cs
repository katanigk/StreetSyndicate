...
{
    /// <summary>Batch 13: full police window pane payload for UI binding.</summary>
    public sealed class PoliceWindowStateModel
    {
        public PoliceWindowMode ActiveMode { get; set; }
